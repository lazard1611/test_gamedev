import { version, getCurrentInstance, inject, ref, watchEffect, watch, useSSRContext, createApp, reactive, unref, isRef, provide, onErrorCaptured, onServerPrefetch, toRef, shallowRef, computed, isReadonly, defineAsyncComponent, withCtx, createVNode, nextTick, defineComponent, h, Suspense, Transition } from 'vue';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./index-c1a39f7d.mjs').then((m) => m.default || m)
  }
];
...
const showPassword_02wWMNZRXX = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const initPopup_5C5YjKUnUH = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  nuxtApp.provide("initPopup", () => {
    const initPopup = (btn, popup2, content, close) => {
      ...
      $close.forEach((item) => {
        item.addEventListener("click", () => {
          popupClose(item.closest(popup2));
        });
      });
      return null;
    };
...
const submitForm_fc109OvEu4 = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const _plugins = [
  ...
  router_jmwsqit4Rs,
  showPassword_02wWMNZRXX,
  initPopup_5C5YjKUnUH,
  submitForm_fc109OvEu4
];
...
const layouts = {
  default: () => import('./default-d5a23182.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./error-component-8959561d.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./island-renderer-5004d645.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
